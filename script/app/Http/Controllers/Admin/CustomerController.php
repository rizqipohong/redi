...
class CustomerController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.customer.show', compact('info', 'histories', 'customers', 'posts', 'guests'));
    }
    ...
    public function orders_customer($id)
    {
        ...
        $returm_item =DB::table('orders')
            ...
            ->get();
        return view('admin.customer.customer', compact('info', 'earnings', 'orders', 'returm_item'));
    }
    ...
    public function orders_show($id)
    {
        ...
        return view('admin.customer.order_show', compact('info', 'order_content', 'order_shipping', 'chat', 'term'));
    }
    ...
    public function orders_guest($id)
    {
        ...
        return view('admin.customer.customer', compact('info', 'earnings', 'orders'));
    }
