...
class CouponController extends Controller
{
    ...
    {
        $posts=Category::where('user_id',Auth::id())->where('type','coupon')->with('products')->latest()->paginate(20);
//        return $posts;
    ...
    {
        $data = Term::all();
        return view('seller.coupon.create', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('seller.coupon.edit',compact('info', 'data'));
    }
