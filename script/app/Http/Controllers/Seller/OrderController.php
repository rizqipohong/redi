...
class OrderController extends Controller
{
    ...
    public function index(Request $request,$type)
    {
        ...
        $type=$type;
//        chat
        $chat_seller = DB::table('chats')->where('seller_id', Auth::id())
            ->orderBy('created_at')->get();
        $term = DB::table('chats')->where('seller_id', Auth::id())
            ->orderBy('created_at')->first();
//        return $chat_customer;
        return view('seller.orders.index',compact('orders','pendings','processing','pickup','completed','archived','canceled','request','type', 'chat_seller', 'term'));
    }
    public function chat(Request $request){
        try{
            ...
            return redirect('/seller/orders/all');
        }catch(\Exception $e){
    ...
    {
        Ordermeta::where('order_id', $id)->update([
            'awb' => $request->awb
        ]);
    ...
    public function show($id)
    {
       ...
       return view('seller.orders.show',compact('info','order_content', 'order_shipping'));
    }
