...
class Guest extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\Order','guest_id','id')->where('status','completed');
    }

    public function orders_processing()
    {
        return $this->hasMany('App\Order','guest_id','id')->where('status','!=','completed')->where('status','!=','canceled');
    }
