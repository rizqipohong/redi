            ...
            <div class="row">
                <div class="col-12  col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
                    ...
                    <div class="card card-primary">
                        <div class="card-header"><h4>{{ __('Daftar Menjadi Seller ') }}</h4></div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="loginform" class="needs-validation"
                                ...
                                <div class="form-group">
                                    <label for="email">{{ __('Nama Toko') }}</label>
                                    <input id="email" type="email"
                                           class="form-control @error('email') is-invalid @enderror" name="email"
                                           value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                                ...
                                <div class="form-group">
                                    <label for="email">{{ __('Lokasi Toko') }}</label>
                                    <input id="email" type="email"
                                           class="form-control @error('email') is-invalid @enderror" name="email"
                                           value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <a href="{{ url('/login') }}"
                                           class="btn btn-success btn-lg btn-block basicbtn" tabindex="4">
                                            {{ __('Login ') }}
                                        </a>
                                    </div>
                            </form>
