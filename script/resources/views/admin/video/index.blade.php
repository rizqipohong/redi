@extends('layouts.app')
@section('head')
    @include('layouts.partials.headersection',['title'=>'Video'])
@endsection
@section('content')
    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="add-new-btn">
                                        <a href="{{ route('admin.customize.createVideo') }}"
                                           class="btn btn-primary float-right">{{ __('Add New Video') }}</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table table-striped table-hover text-left table-borderless">
                            ...
                            @foreach($data as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->user->name ?? '' }}</td>
                                    <td>
                                        <a href="{{ route('admin.customize.editVideo',$row->id) }}"
                                           class="btn btn-primary btn-sm text-center"><i class="far fa-edit"></i></a>
                                        <a href="{{ route('admin.customize.deleteVideo',$row->id) }}"
