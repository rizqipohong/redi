    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="basicform_with_reload" action="{{ route('admin.customer.store') }}" method="post">
          ...
          <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Seller Name') }}</label>
        ...
        <div class="form-group row mb-4">
          <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Seller Email') }}</label>
          <div class="col-sm-12 col-md-7">
