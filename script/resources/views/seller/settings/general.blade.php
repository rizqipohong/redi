        ...
        <div class="card-body">
            <div class="row">
              <div class="col-12 col-sm-12 col-md-4">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#pwa" role="tab" aria-controls="profile" aria-selected="false">PWA Settings</a>
                </li>
...
{{--                    <input class="form-control" name="city" value="{{ $location->city ?? '' }}" type="text" value="" required="">--}}
                    <select style="width: 100%" class="form-control select2" name="city"  required>
                        @foreach($origin as $link)
                            <option value="{{ $link->origin_code ?? ''}}" {{  $link->origin_code  ?? '' == $location->city ?? '' ? 'selected' : '' }}>{{ $link->origin_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-row">
