  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="basicform_with_reload" action="{{ route('seller.seller.store') }}" method="post">
          @csrf

          <div class="form-group row mb-4">
          <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Staff Name') }}</label>
        ...
        <div class="form-group row mb-4">
          <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Staff Email') }}</label>
          <div class="col-sm-12 col-md-7">
