@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>'Seller'])
@endsection
@section('content')
				...
				<div class="card profile-widget">
					...
					<div class="profile-widget-description">
						...
						<ul class="list-group">
							...
							<li class="list-group-item">{{ __('Total Sellers :') }} {{ number_format($info->customers_count) }}</li>
								...
								<table class="table table-striped table-hover text-center table-borderless">
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td><a href="{{ url('/admin/customer/orders/customer', $row->id)  }}">{{ $row->name }}</a></td>
                                            <td>{{ $row->email }}</td>
...
{{--                                    guesst role--}}
                                        @foreach($guests as $row)
                                            <tr>
                                                <td><input type="checkbox" name="ids[]" value="{{ $row->id }}"></td>
                                                <td><a href="{{ url('/admin/customer/orders/guest', $row->id)  }}">{{ $row->name }}</a></td>
                                                <td>{{ $row->email }}</td>
                                                <td>{{ $row->orders_count }}</td>
                                                <td>{{ __('Guest') }}</td>
