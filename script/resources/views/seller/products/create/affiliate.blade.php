            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="card-body">
                                <form method="post" action="{{ route('seller.product.affiliate',$info->id) }}"  class="affiliate_form">
                                    @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-8 col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input placeholder="%" id="hm" type="tel" size="4" maxlength="2" name="affiliate"
                                                   onchange="changeHandler(this)"  value="{{ $info->price->affiliate ?? '' }}" class="form-control">
                                        </div>
