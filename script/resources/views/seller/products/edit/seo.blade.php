...
{{--								</li>--}}
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('seller/product/'.$info->id.'/affiliate') }}"><i class="fab fa-affiliatetheme"></i> {{ __('Affiliate') }}</a>
                            </li>
						</ul>
					</div>
					<div class="col-sm-9">
						...
						<div class="form-group">
                            ...
                            <div style="float: right;">
                                <a class="btn btn-danger basicbtn"
                                   href="{{ url('seller/product/'.$info->id.'/files') }}">{{ __('Previous') }}</a>
