            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <form method="post" action="{{ route('seller.products.price',$info->price->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <input type="hidden" value="{{$info->id}}" name="term_id">
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-9 col-12">
                                        <input type="number" value="{{ $info->price->special_price }}" step="any"
                                ...
                                <a class="btn btn-danger basicbtn"
                                   href="{{ url('seller/product/'.$info->id.'/edit') }}">{{ __('Previous') }}</a>
