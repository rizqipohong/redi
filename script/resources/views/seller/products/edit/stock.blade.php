                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <ul class="nav nav-pills flex-column">
                                ...
                                {{--								</li>--}}
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('seller/product/'.$info->id.'/affiliate') }}"><i
                            ...
                            <form  method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="stock_manage" id="stock_manage" class="form-control">
                                        <option value="1"
                                                @if($info->stock->stock_manage == 1) selected @endif>{{ __('Manage Stock') }}</option>
                                        <option value="0"
                                                @if($info->stock->stock_manage == 0) selected @endif>{{ __('Dont Need To Manage Stock') }}</option>
                                    </select>
                                </div>
                                <div class="stock_area @if($info->stock->stock_manage == 0) none @endif">
                                    <div class="form-group">
                                        ...
                                        <select name="stock_status" id="stock_status" class="form-control">
                                            <option value="1"
                                                    @if($info->stock->stock_status == 1) selected @endif>{{ __('In Stock') }}</option>
                                            <option value="0"
                                                    @if($info->stock->stock_status == 0) selected @endif>{{ __('Out Of Stock') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="stock_qty" value="{{ $info->stock->stock_qty }}"
                                               class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="weight">{{ __('Weight') }} ( aditional )</label>
                                        <input type="text" name="weight" value="{{ $info->stock->weight }}"
                                               class="form-control">
                                    </div>
                                </div>

                                <div style="float: right;">
                                    <a class="btn btn-danger basicbtn"
                                       href="{{ url('seller/product/'.$info->id.'/image') }}">{{ __('Previous') }}</a>
                                    <button type="submit" class="btn btn-primary basicbtn">{{ __('Next Step') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
