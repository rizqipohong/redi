                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <ul class="nav nav-pills flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ url('seller/product/'.$info->id.'/files') }}"><i
                        ...
                        <div class="col-sm-9">
                            ...
                            <button class="btn btn-primary float-right mb-2" data-toggle="modal"
                                    data-target="#attribute_modal">{{ __('Create File') }}</button>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-primary edit"
                                                            ...
                                                            data-name="{{ $row->name }}" data-url="{{ $row->url }}"><i
                            ...
                            <div style="float: right;">
                                <a class="btn btn-danger basicbtn"
                                   href="{{ url('seller/product/'.$info->id.'/inventory') }}">{{ __('Previous') }}</a>
                                <a class="btn btn-primary basicbtn"
                                   href="{{ url('seller/product/'.$info->id.'/seo') }}">{{ __('Next Step') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
