                                    ...
                                    <form action="{{ url('/user/register-user') }}" method="POST"
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="text"
                                                   id="reg-fname" value="{{ old('name') }}" name="name"
                                                   placeholder="Name">
                                        </div>

                                        <div class="u-s-m-b-30">
                                            <label class="gl-label" for="reg-fname">{{ __('Username') }} *</label>
                                            <input class="input-text input-text--primary-style" type="text"
                                                   id="reg-fname" value="{{ old('username') }}" name="username"
                                                   placeholder="Username">
                                        </div>
                                        <div class="u-s-m-b-30">
                                            <label class="gl-label" for="reg-email">{{ __('E-Mail') }} *</label>
                                            <input class="input-text input-text--primary-style"
                                                   value="{{ old('email') }}" name="email" id="reg-email"
                                        ...
                                        <div class="u-s-m-b-30">
                                            <label class="gl-label" for="reg-password">{{ __('Confirm Password') }}
                                                *</label>
                                            <input class="input-text input-text--primary-style" type="password"
                                                   name="password_confirmation" id="reg-password"
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            <button class="btn btn--e-transparent-brand-b-2 basicbtn"
