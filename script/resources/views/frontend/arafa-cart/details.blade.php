                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="pd-detail">
                            ...
                            <div class="u-s-m-b-15">
                                ...
                                <span
                                    class="pd-detail__preview-desc">{{ Str::limit($content->excerpt ?? '',300) }}</span>
                            </div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">
                                ...
                                <form method="post" class="pd-detail__form cart-form" action="{{ url('/addtocart') }}">
                                                ...
                                                @foreach ($option->childrenCategories as $row)
                                                    <div
                                                        ...
                                                        <input data-amount="{{ $row->amount }}"
                                                               ...
                                                               name="option[]" @else name="option[{{ $key }}]"
                                                               type="radio" @endif  value="{{ $row->id }}"
                                    ...
                                    <div class="pd-detail-inline-2">
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            @else
                                                <a href="{{ url('/user/login') }}"><button class="btn btn--e-brand-b-2 submit_btn"
                                                     type="button"> {{ __('Login First') }}
                                                </button></a>
                                            @endif
                                        </div>
                                    </div>
