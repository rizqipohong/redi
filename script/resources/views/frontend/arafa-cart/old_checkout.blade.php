                                    ...
                                    <div class="o-summary">
                                       ...
                                       @foreach ($row->options->attribute as $attribute)
                                           ...
                                           @endforeach
                                                                ...
                                                                <span
                                                                    class="o-card__price">{{ amount_format($row->price) }}</span>
                                                            </div>
                                                        </div>
                                                        <a href="{{ url('/cart_remove',$row->rowId) }}"
                                                        ...
                                                        <div class="radio-box">
                                                            ...
                                                            <div class="radio-box__state radio-box__state--primary">
                                                                <label class="radio-box__label"
                                                                       for="payment_method_{{ $key }}">{{ $data->title }}</label>
                                                            </div>
                                                        </div>
                                                    @if(isset($data->additional_details))
                                                        <!--====== End - Radio Box ======-->
                                                            <span
                                                                class="gl-text u-s-m-t-6 payment_method_{{ $key }}">{{ $data->additional_details }}</span>
                                                        @endif
                                                    </div>
                                                @endforeach
                                                @if(Cart::count() > 0)
