        ...
        <div class="container">
            ...
            <div class="primary-nav">
                ...
                <form class="main-form" action="{{ url('/shop') }}">
                    ...
                    <input class="input-text input-text--border-radius input-text--style-1 src" value="{{ $src ?? '' }}"
                           name="src" type="text" id="main-search" placeholder="Search">
                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                                ...
                                <li class="has-dropdown" data-tooltip="tooltip" data-placement="left"
                                    ...
                                    <ul class="w-120">
                                        @foreach($languages as $lang_key=> $language)
                                            <li>
                                                <a class="@if($language == Session::get('locale')) u-c-brand @endif"
                                                   href="{{ url('/make_local?'.'lang='.$language.'&full='.$lang_key) }}">{{ $lang_key  }}</a>
                                            </li>
                                        @endforeach
                            ...
                            @if(Cache::has(domain_info('user_id').'store_email'))
                                <li data-tooltip="tooltip" data-placement="left" title="Mail">
                                    <a href="mailto:{{ Cache::get(domain_info('user_id').'store_email') }}"><i
        ...
        <div class="container">
                                    ...
                                    <div class="mega-menu">
                                        <div class="mega-menu-wrap">
                                            <div class="mega-menu-list">
                                                <ul id="menu_category">
                                                    <li class="cat-item cat-item"><p><span
                                                                class="content-placeholder h-20">&nbsp;</span></p></li>
                                                    <li class="cat-item cat-item"><p><span
                                                                class="content-placeholder h-20">&nbsp;</span></p></li>
                                                    <li class="cat-item cat-item"><p><span
                                                                class="content-placeholder h-20">&nbsp;</span></p></li>
            ...
            <!--====== End - Dropdown Main plugin ======-->
                ...
                <div class="menu-init" id="navigation2">
                    <button class="btn btn--icon toggle-button toggle-button--secondary fas fa-bars"
                            type="button"></button>
                    <!--====== Menu ======-->
                    <div class="ah-lg-mode">
                        <span class="ah-close">✕ {{ __('Close') }}</span>
                ...
                <div class="menu-init" id="navigation3">
                    ...
                    <div class="ah-lg-mode">
                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                            ...
                            <li>
                                <a class="mini-cart-shop-link" href="{{ url('/wishlist') }}"><i
                                        class="far fa-heart"></i><span
                                        class="total-item-round wishlist_count">{{ $wishlist }}</span></a>
                            </li>
                            <li class="has-dropdown">
                                ...
                                <div class="mini-cart">
                                    ...
                                    @foreach($cart_content as $row)
                                                ...
                                                <div class="mini-product">
                                                    <div class="mini-product__image-wrapper">
                                                        <a class="mini-product__link"
                                                           href="{{ url('/product/'.$row->name.'/'.$row->id) }}">
                                                            <img class="u-img-fluid"
                                                                 src="{{ asset($row->options->preview) }}" alt=""></a>
                                                    </div>
                                       ...
                                       <a href="{{ url('/product/'.$row->name.'/'.$row->id) }}">{{ $row->name }}</a></span>
                                                        ...
                                                        <span
                                                            class="mini-product__price">{{ amount_format($row->price) }}</span>
                                                    </div>
                                                </div>
                                                <a class="mini-product__delete-link far fa-trash-alt"
                                                   onclick="remove_cart({{ $row->id }})"></a>
                                    ...
                                    <div class="mini-product-stat">
                                        <div class="mini-total">
                                            ...
                                            <span class="subtotal-value"
                                                  id="cart_sub_total">{{ amount_format($cart_subtotal) }}</span>
                                        </div>
                            ...
                            @php
                            if( Auth::guard('customer')->check()){
                                    $account = App\Models\AccountRatapay::where('customer_id', Auth::guard('customer')->user()->id)->first();

                            }
                            @endphp
                            <li class="has-dropdown">
                                <a class="mini-cart-shop-link"><i class="fas fa-wallet"></i>
                                    <span class="total-item-round ">{{ amount_format($account->account_balance ?? '0') }}</span></a>
                                <!--====== Dropdown ======-->
                                <span class="js-menu-toggle"></span>
                                <div class="mini-cart">
                                    <!--====== Mini Product Container ======-->
                                    <div class="mini-product-container gl-scroll u-s-m-b-15 cart-list">
                                        <div class="card-mini-product  cart-row">
                                            <div class="mini-product">
                                                <div class="mini-product__info-wrapper">
                                                    Saldo: {{ amount_format($account->account_balance ?? '0') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
