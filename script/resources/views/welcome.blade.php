                        ...
                        <div class="feature-item mb-5 mb-lg-0">
                            ...
                            @if(!empty($about_1->btn_text) && !empty($about_1->btn_link))
                                <a href="{{ url($about_1->btn_link) }}"
                                   class="btn btn-main btn-round-full">{{ $about_1->btn_text }}</a>
                            @endif
                        </div>
                        ...
                        <div class="feature-item mb-5 mb-lg-0">
                            ...
                            @if(!empty($about_2->btn_text) && !empty($about_2->btn_link))
                                <a href="{{ url($about_2->btn_link) }}"
                                   class="btn btn-main btn-round-full">{{ $about_2->btn_text }}</a>
                            @endif
                        </div>
                        ...
                        <div class="feature-item mb-5 mb-lg-0">
                            ...
                            @if(!empty($about_3->btn_text) && !empty($about_3->btn_link))
                                <a href="{{ url($about_3->btn_link) }}"
                                   class="btn btn-main btn-round-full">{{ $about_3->btn_text }}</a>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="about-content pl-4 mt-4 mt-lg-0">
                        ...
                        @if(!empty($ecom_features->btn_link) && !empty($ecom_features->btn_text))
                            <a href="{{ url($ecom_features->btn_link) }}"
                               class="btn btn-main-2 btn-round-full btn-icon">{{ $ecom_features->btn_text }}<i
